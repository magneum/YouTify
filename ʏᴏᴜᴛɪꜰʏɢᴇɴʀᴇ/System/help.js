const { MessageEmbed } = require("../../YouTifyPlayer/YouTified.djs/typings");
// ===========================================================================================================================
...
asetrate,bassboost,echo, flanger, nightcore, phaser,slow,speed, subboost, superslow,superspeed, 
surround,3D,8D,vibrato....
More Coming Soon!! :)`
          )
          .addField(
            `\`Brought To You by\``,
