...
module.exports.run = async (client, message) => {
    ...
    if (Channel.full) {
        ...
        await message.channel.send(new MessageEmbed()
            ...
            .setThumbnail(`https://i.postimg.cc/9f0mS5NY/YouTify.png`)
            .setFooter(`👈🏽‍Reqstd by ${message.author.username}`, message.author.avatarURL({ dynamic: true }))
            .addField(`\`☣️Error\``, `**Current Voice Channel is Full! Please try in another Voice Channel**`, true))
            .catch(console.error);
        return;
    }
    // ===========================================================================================================================
    ...
    if (!Channel.joinable || !Channel.speakable) {
        ...
        await message.channel.send(new MessageEmbed()
            ...
            .setThumbnail(`https://i.postimg.cc/9f0mS5NY/YouTify.png`)
            .setFooter(`👈🏽‍Reqstd by ${message.author.username}`, message.author.avatarURL({ dynamic: true }))
            .addField(`\`☣️Error\``, `**Current Voice Channel is Not Joinable Or Speakable!! Please try in another Voice Channel**`, true))
            .catch(console.error);
        return;
    }
    // ===========================================================================================================================
    ...
    if (message.guild.me.voice.channel) {
        ...
        await message.channel.send(new MessageEmbed()
            ...
            .setThumbnail(`https://i.postimg.cc/9f0mS5NY/YouTify.png`)
            .setFooter(`👈🏽‍Reqstd by ${message.author.username}`, message.author.avatarURL({ dynamic: true }))
            .addField(`\`☣️Error\``, `**Already Connected To ${message.guild.me.voice.channel.id == Channel.id ? "Your" : "A"} Voice Channel!**`, true))
            .catch(console.error);
        return;
    }
    // ===========================================================================================================================
