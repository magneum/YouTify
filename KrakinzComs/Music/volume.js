...
module.exports.run = async (client, message, args) => {
    ...
    if (!NewVolume) {
        ...
        await message.channel.send(new MessageEmbed()
            ...
            .setThumbnail(`https://i.postimg.cc/9f0mS5NY/YouTify.png`)
            .setFooter(`👈🏽‍Reqstd by ${message.author.username}`, message.author.avatarURL({ dynamic: true }))
            .addField(`\`🔊Volume\``, `**Current Queue Volume is set to ${Queue.Volume}!**`, true))
            .catch(console.error);
        return;
    }
    // ===========================================================================================================================
    ...
    if (isNaN(NewVolume) || parseInt(NewVolume) < 1) {
        ...
        await message.channel.send(new MessageEmbed()
            ...
            .setThumbnail(`https://i.postimg.cc/9f0mS5NY/YouTify.png`)
            .setFooter(`👈🏽‍Reqstd by ${message.author.username}`, message.author.avatarURL({ dynamic: true }))
            .addField(`\`☣️Error\``, `**Invalid Volume Provided! Use ${client.YouTix}help to learn more..**`, true))
            .catch(console.error);
        return;
    }
    ...
    if (NewVolume == Queue.Volume) {
        ...
        await message.channel.send(new MessageEmbed()
            ...
            .setThumbnail(`https://i.postimg.cc/9f0mS5NY/YouTify.png`)
            .setFooter(`👈🏽‍Reqstd by ${message.author.username}`, message.author.avatarURL({ dynamic: true }))
            .addField(`\`☣️Error\``, `**YouTify™ Current Queue Volume Already set to ${NewVolume}!**`, true))
            .catch(console.error);
        return;
    }
    // ===========================================================================================================================
    ...
    await message.channel.send(new MessageEmbed()
        ...
        .setURL("https://github.com/Krakinz")
        .setThumbnail(`https://i.postimg.cc/9f0mS5NY/YouTify.png`)
        .addField(`\`🔊Volume\``, `**YouTify™ Current Queue Volume Already set to ${NewVolume}!**`, true))
        .catch(console.error);
    return;
};
// ===========================================================================================================================
